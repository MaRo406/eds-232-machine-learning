...
This week's lab follows a modeling project described by

## Data

Grab the model traning data set from Git
...
1.  Now fit your final model to the big dataset: eval.data.csv
