...
10-fold CV MSE for a ridge and lasso model. What's the "rule of 1 standard deviation"? <!-- The first and second vertical dashed lines represent the   --> <!--   value with the minimum MSE and the largestvalue within one standard error of it. --> In both models we see a slight improvement in the MSE as our penalty log(λ) gets larger, suggesting that a regular OLS model likely overfits the training data. But as we constrain it further (i.e., continue to increase the penalty), our MSE starts to increase.
