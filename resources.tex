...
\hypertarget{algorithm-selection-flowchart}{%
\paragraph{Algorithm Selection
Flowchart}\label{algorithm-selection-flowchart}}

\hypertarget{animated-explainers}{%
\paragraph{Animated Explainers}\label{animated-explainers}}

\url{https://mlu-explain.github.io/bias-variance/}
\url{https://bbest.github.io/eds232-ml/resources.html}

\hypertarget{literature}{%
\paragraph{Literature}\label{literature}}

\hypertarget{context-for-weekly-labs}{%
\subparagraph{Context for Weekly Labs}\label{context-for-weekly-labs}}

\hypertarget{machine-learning-in-environmental-science}{%
\subparagraph{Machine Learning in Environmental
Science}\label{machine-learning-in-environmental-science}}

Machine Learning for Ecology and Sustainable Natural Resource Management
\url{https://link.springer.com/book/10.1007/978-3-319-96978-7}
...
\hypertarget{key-ml-papers-and-empirical-foundation-of-heuristics}{%
\subparagraph{Key ML Papers and Empirical Foundation of
Heuristics}\label{key-ml-papers-and-empirical-foundation-of-heuristics}}
